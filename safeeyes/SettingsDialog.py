...
class SettingsDialog(object):
    ...
    def __create_break_item(self, name):
        ...
        """
        builder = Gtk.Builder()
        builder.add_from_file('/home/gobinath/Workspace/slgobinath/SafeEyes/safeeyes/glade/item_break.glade')
    ...
    def __create_plugin_item(self, plugin_config):
        ...
        """
        builder = Gtk.Builder()
        builder.add_from_file('/home/gobinath/Workspace/slgobinath/SafeEyes/safeeyes/glade/item_plugin.glade')
