...
def on_start() -> None:
    ...
    if idle_monitor is None:
        if is_wayland_and_gnome:
            ...
            from .ext_idle_notify import IdleMonitorExtIdleNotify, EXT_IDLE_NOTIFY_IMPORT_ERROR
            if EXT_IDLE_NOTIFY_IMPORT_ERROR:
                logging.warning("SmartPause plugin disabled: ext_idle_notify_v1 not available on this system.")
